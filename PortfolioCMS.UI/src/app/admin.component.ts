          ...
          <div class="space-y-6">
            <div class="bg-[#12161f] border border-gray-800/80 rounded-3xl p-6 md:p-8">
              ...
              <form (ngSubmit)="editingProject ? updateProject() : createProject()" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input type="text" [(ngModel)]="formProject.imageUrl" name="imageUrl" placeholder="Resim URL (Opsiyonel)" class="bg-[#0a0c10] border border-gray-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-amber-400">
